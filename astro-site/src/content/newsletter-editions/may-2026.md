...
description: "Three bets are forming in developer tooling: the harness, the integration layer, the app. Plus links on the Cursor SDK, Warp going open source, Claude Design, and MCP for production agents."
