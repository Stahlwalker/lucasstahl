...
description: "Solar is a runtime UI framework for AI agents — no build step, no compiler. Plus TypeScript 7's Go-powered builds and CodeTV's Web Dev Challenge."
...
- <img src="/blog/images/newsletters/Solar.png" alt="Solar — Runtime UI for AI-generated code" class="li-thumb"><span class="li-text">**[Solar — Runtime UI for AI-generated code](https://solarbuild.dev/)**<br>Agents are good at writing code, not navigating build toolchains. Solar gives them a fixed surface.<br>_Luke Stahl_</span>
- <img src="/blog/images/newsletters/Solar_docs.png" alt="Solar framework documentation" class="li-thumb"><span class="li-text">**[Solar framework documentation](https://docs.solarbuild.dev/docs/introduction)**<br>The Solar docs are built on Mintlify. Components use a JSON schema with explicit contracts, and ContractError feedback lets agents self-correct without human intervention.</span>
