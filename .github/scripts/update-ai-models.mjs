...
- After the frontmatter code block, add a section starting with "CHANGELOG:" listing each change with a source URL
...
Search for recent updates to: GPT-5, Claude 4.6, Gemini 3, Grok 4, Llama 4, DeepSeek, Mistral, Qwen 3, Midjourney, Imagen, DALL-E, Stable Diffusion, Nano Banana, and any major new AI models released this week.`;
